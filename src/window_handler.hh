...
private:
	...
	static void fw_resize_callback(GLFWwindow* window, int width, int height)
	{
		instance().resize_callback(window, width, height);
	};
	static void fw_error_callback(int error, const char* description)
	{
	...
	static void fw_mouse_callback(GLFWwindow* window, double xpos, double ypos)
	{
