...
void main()
{
	...
	float fxaaQualityEdgeThreshold = 0.116;
	...
	vec4 fxaaConsole360ConstDir = vec4(0, 0, 0, 0);

	/// TODO: Make it constant uniform
	vec2 texelSize = vec2(1.0 / resolution.x, 1.0 / resolution.y);
	vec2 fxaaQualityRcpFrame = texelSize;
	vec4 fxaaConsoleRcp = vec4(-texelSize[0], -texelSize[1], texelSize[0], texelSize[1]);
	vec4 fxaaConsoleRcpFrameOpt = fxaaConsoleRcp * 0.5f;
	vec4 fxaaConsoleRcpFrameOpt2 = fxaaConsoleRcp * 2.0f;

	vec4 fxaaConsolePosPos = vec4(TexCoords - 0.5 * fxaaQualityRcpFrame, TexCoords + 0.5 * fxaaQualityRcpFrame);
